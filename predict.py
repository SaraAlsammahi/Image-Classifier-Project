...
def parse_args():
    ...
    parser.add_argument('--filepath', dest='filepath', default='ImageClassifier/flowers/test/1/image_06743.jpg') 
    # use a deafault filepath to a primrose image 
    parser.add_argument('--category_names', dest='category_names', default='ImageClassifier/cat_to_name.json')
